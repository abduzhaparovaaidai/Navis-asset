      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:h-[535px] gap-[10px]">
        ...
        <div className="aspect-square lg:aspect-auto lg:h-full overflow-hidden bg-[#F5F7FA] rounded-[20px] lg:rounded-[30px] p-[16px] lg:p-[32px] flex flex-col justify-between">
          ...
          <div className="flex gap-[10px] items-center">
            <NavLink
              to="/request"
              className="flex-1 h-[50px] px-[22px] bg-gradient-to-r from-[#D4151C] to-[#D35400] text-white text-[16px] font-semibold rounded-[8px] flex items-center justify-center hover:opacity-90 transition duration-300 whitespace-nowrap"
            >
              Оставить заявку
            </NavLink>
            ...
            <NavLink
              to="/about-us"
              className="flex-1 h-[50px] px-[22px] border border-[#D8D8D8] bg-transparent text-black text-[16px] font-semibold rounded-[8px] flex items-center justify-center gap-[4px] hover:bg-black/5 transition duration-300 whitespace-nowrap"
            >
              Подробнее
